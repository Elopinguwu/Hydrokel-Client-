...
public class ModuleButton {
	...
	public ModuleButton(Module imod, Panel pl) {
		 ...
		 */
		if (Main.instance.setmgr.getSettingsByMod(imod) != null)
			for (Setting s : Main.instance.setmgr.getSettingsByMod(imod)) {
				if (s.isCheck()) {
	...
	public boolean mouseClicked(int mouseX, int mouseY, int mouseButton) {
		...
		if (mouseButton == 0) {
			...
			if(Main.instance.setmgr.getSettingByName("Sound").getValBoolean())
