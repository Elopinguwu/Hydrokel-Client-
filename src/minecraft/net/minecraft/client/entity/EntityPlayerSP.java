...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        EventMotion e = new EventMotion(EventMotion.State.PRE, posX, getEntityBoundingBox().minY, posZ, rotationYaw, rotationPitch, onGround, isSprinting(), isSneaking());
        e.call();
        ...
        float yaw = e.getYaw(), pitch = e.getPitch();
        boolean ground = e.isGround(), flag = e.isSprint(), flag1 = e.isSneak();

        if(this.mc.gameSettings.thirdPersonView != 0) {
            this.rotationYawHead = e.getYaw();
            this.renderYawOffset = e.getYaw();
        }
    ...
    @Override
    public Object getDisplayNameString() {
        return null;
    }
