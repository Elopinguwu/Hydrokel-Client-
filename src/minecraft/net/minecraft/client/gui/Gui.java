...
public class Gui
{
     ...
     */
    public static void drawTexturedModalRect(double x, double y, double u, double v, double w, double h)
    {
        float f = 0.00390625F;
        ...
        worldrenderer.pos((double)(x + 0), (double)(y + h), (double)zLevel).tex((double)((float)(u + 0) * f), (double)((float)(v + h) * f1)).endVertex();
        worldrenderer.pos((double)(x + w), (double)(y + h), (double)zLevel).tex((double)((float)(u + w) * f), (double)((float)(v + h) * f1)).endVertex();
        worldrenderer.pos((double)(x + w), (double)(y + 0), (double)zLevel).tex((double)((float)(u + w) * f), (double)((float)(v + 0) * f1)).endVertex();
