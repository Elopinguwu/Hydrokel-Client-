...
public class Translate {
    ...
    private void resetIfNeeded() {
    	if(this.lastMS == -69420) {
    		this.lastMS = System.currentTimeMillis();
    	}
    }
    
    public boolean interpolate(float targetX, float targetY, int xSpeed, int ySpeed) {
    	resetIfNeeded();
    ...
    public boolean interpolate(float targetX, float targetY, double speed) {
    	resetIfNeeded();
